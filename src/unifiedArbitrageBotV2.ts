...
console.log("🚀 Starting Unified Arbitrage Bot V2...");
console.log("📊 Running PumpSwap, Meteora DammV2, and Arbitrage Monitoring in single process...\n");

// Import both DEX services - they will start automatically
// We need to import them after setting up the arbitrage aggregator
...
process.on('SIGINT', () => {
  console.log('\n🛑 Shutting down unified arbitrage bot...');
  process.exit(0);
});
