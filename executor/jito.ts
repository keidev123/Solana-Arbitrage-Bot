...
import { BLOCK_ENGINE_URL, JITO_KEY } from '../constants';
...
export const executeBundle = async (connection: Connection, transactions: VersionedTransaction[]) => {
  try {
    ...
    console.log("ExecuteBundle result:", result)
    if (!result.ok) {
    ...
    console.log("Error while executing bundle transaction")
  }
}
